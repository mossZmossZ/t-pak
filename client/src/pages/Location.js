        ...
        return(
            <div className="post-container">
                ...
                <div className="select-container">
                    <Select  isSearchable={false} options={uniOptions} onChange={(choice) => setUniSelect(choice.value)}/>
                    <Select  isSearchable={false} options={modeOptions} onChange={(choice) => setModeSelect(choice.value)}/></div>
                <hr/>
        ...
        return(
            <div className="post-container">
                ...
                <div className="select-container">
                    ...
                    <Select  defaultValue={{label:`${modeSelect}`}}  isSearchable={false} options={modeOptions} onChange={(choice) => setModeSelect(choice.value)}/>
                </div>
                <hr/>
